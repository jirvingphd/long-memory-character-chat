...
#   # Display the combined table content with st.markdown
    st.markdown(table_content, unsafe_allow_html=True)

#     # Display each metric using st.markdown
#     st.markdown(f"> Total current memory tokens  {st.session_state['agent'].current_memory_tokens} ")
#     st.markdown(f"> Total cost of this conversation is: {st.session_state['agent'].total_cost} ")
#     st.markdown(f"> Total tokens sent is: {st.session_state['agent'].total_tokens} |")
#     st.markdown(f"> Average number of tokens per interaction is: {st.session_state['agent'].average_tokens} |")
#     st.markdown(f"> Average cost per interaction is: {st.session_state['agent'].average_cost} |")
#     st.markdown(f"> Total number of interactions is: | {len(st.session_state['agent'].chat_history) // 2} |")
  
    # # Combine all metrics into a single multi-line string with f-strings
    # metrics_string = (
    ...
    #     f" Total tokens sent is: {st.session_state['agent'].total_tokens} \n",
    ...
    #     # Display the combined metrics string with st.markdown
    # st.markdown("\n".join(metrics_string))